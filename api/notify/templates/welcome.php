                                        ...
                                        <td style="word-break:break-word;font-size:0px;padding:0px 0px 35px 0px;" align="left">
                                          <div style="cursor:auto;color:#000000;font-family:Open Sans, Helvetica, Sans-Serif;font-size:14px;font-weight:200;line-height:22px;">
                                            <div class="mktEditable" id="bodyCopy">
                                              ...
                                              Welcome to LiveHUB, we're excited to have you on board. <br><br>
                                              To get started, take a look at your <a href="https://www.livehub.com.au/app/myaccount" style="color: #ffc13c; text-decoration:none;">My Account</a> page and setup your profile.
                                              <br><br>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td style="border-radius:4px;color:#ffffff;cursor:auto;padding:0;" align="center" valign="middle" bgcolor="#ffc13c">
                                                  <div class="mktEditable" id="bodyCopyCTA"><a href="https://www.livehub.com.au/app/myaccount" style="display:inline-block;text-decoration:none;background:#ffc13c;border-radius:4px;color:#5d5c63;font-family:Open sans, Helvetica, Arial, Sans serif;font-size:14px;font-weight:500;margin:0px;padding:10px
25px;letter-spacing:1px;border:1px solid #5d5c63;" target="_blank">MY ACCOUNT</a></div>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
